      ...
      >
        <header className="w-screen pb-5 pt-5 pr-10 pl-20 flex flex-col items-start justify-center">
          ...
          >
            ...
            >
              <h1 className="gradient-text text-[5.25rem] font-Valve tracking-wide">
                Nathan Lomnicky
              </h1>
          ...
          >
            <h3 className="text-xl mr-160 font-PatuaOne tracking-wide xl:mr-180 lg:mr-160 md:mr-60">
              ...
              systems that make experiences fun and engaging, particularly
              combat and player progression.
              <br />
              <br />I enjoy making satisfying and progressive systems for
              players.
            </h3>
          </div>
