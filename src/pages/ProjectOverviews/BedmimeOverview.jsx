  ...
  return (
    <div>
      ...
      <GreenSection
        ...
        ContentRight={
          <div className="w-full h-full flex flex-col">
            <h6 className="overviewTextBodyWhite h-full mr-3 ml-4 mt-2 justify-start leading-7.5 text-xl">
              To reconcile this, I decided to inversely tie the players score to
              the delay between mime attacks. This meant that, as the player did
              better, the game got harder, rather than players being punished
              simply for playing longer. <br />
              <br />
              This worked much better in testing, and gave new players the
              ability to learn the game before being sent back to the title
              screen, encouraging a second or third run. <br />
              <br /> For a bit of added challenge, I also tied this same value
              to the rate at which the Mime's patience bar would decrease,
              really pushing players to be ready at any moment, and challenging
              them for the high score.
            </h6>
          </div>
        }
      />
